...
@app.route("/mail_afficher/<string:order_by>/<int:id_genre_sel>", methods=['GET', 'POST'])
def mails_afficher(order_by, id_genre_sel):
...
"""
    ...
    Remarque :  Dans le champ "nom_genre_delete_wtf" du formulaire "genres/mails_delete_wtf.html",
    ...
    try:
        ...
        if request.method == "POST" and form_delete.validate_on_submit():
            ...
            if form_delete.submit_btn_conf_del.data:
                ...
                # le formulaire "genres/mails_delete_wtf.html" lorsque le bouton "Etes-vous sur d'effacer ?" est cliqué.
